...
.wf_pklist_dashboard_box{ display:inline-block; margin-top:25px; max-width:150px; width:100%; height:150px; border:solid 1px rgba(220,220,220,1); box-shadow:0px 1px 7px -1px rgb(230, 230, 230.5); background:rgba(250,250,250,1); }
