...
{   
    ...
    public static $active_pdf_lib='dompdf';
    ...
    */
	public static function generate_pdf($html, $basedir, $name, $action='')
    {
        ...
        if(!isset(self::$pdf_libs[self::$active_pdf_lib])) /* check active lib exists in the lib list */
        {
            _e('Activated PDF library is not found.', 'print-invoices-packing-slip-labels-for-woocommerce');
            return;
        }
