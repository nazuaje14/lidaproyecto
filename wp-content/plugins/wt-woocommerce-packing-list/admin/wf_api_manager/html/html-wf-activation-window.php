...
<div class="activation_window">
	<h3><span>Licence activation</span></h3>
	<div class="aw-contents-container">
		<div id="aw-activation" class="content-row <?php echo $show_activation?>">
			...
			<div class="aw-cell">
				...
				<input type="button" id="btn_licence_activate" class="aw-button aw-main-button button-primary" value="Activate">
			</div>
			<div style="clear:both;"></div>
			<div class="content-row" style="float: left;">
				<p class="aw-note-cell">Check <a href="https://www.webtoffee.com/my-account/" target="_blank">My Account</a> for API Keys and API Downloads.</p>
			</div>
		</div>
