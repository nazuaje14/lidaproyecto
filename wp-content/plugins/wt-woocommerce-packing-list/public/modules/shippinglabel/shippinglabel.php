...
class Wf_Woocommerce_Packing_List_Shippinglabel
{
	...
	*/
	...
	public function add_email_print_buttons($html, $order, $order_id, $email_obj, $sent_to_admin)
	{
        ...
        {
            Wf_Woocommerce_Packing_List::generate_print_button_for_user($order, $order_id, $this->module_base, esc_html__('Print Shipping Label', 'wf-woocommerce-packing-list'), true, $sent_to_admin); 
        }
	    return $html;
	}
