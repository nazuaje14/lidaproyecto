<style type="text/css">
  .clearfix::after {
    ...
    .wfte_product_table_body td, .wfte_payment_summary_table_body td{padding:8px 5px;font-size:12px; line-height:10px; border:solid 1px #dadada; font-family:"Helvetica Neue", Roboto, Arial, "Droid Sans", sans-serif;}
