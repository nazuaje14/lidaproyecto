...
$arr=array(
	...
	'wf_shippinglabel_contactno_email'=>__('Allows displaying additional details pertaining to your order in the shipping label. Defaulted to certain common meta values that can be selected from the drop-down. Click on Add existing order meta field button and enter appropriate field name/meta key to include respective custom product meta','wf-woocommerce-packing-list'),
