...
class Wf_Woocommerce_Packing_List_Customizer
{
	...
	*/
	protected function load_default_templates($path, $template_type, $template_id='', $no_html=false)
	{
	...
	public function get_template_html($template_type)
	{
		...
		if($template_type!="")
		{
			...
			}else
			{
				...
				if($def_template_path) //module exists/ template exists
				{
					$template_arr=$this->load_default_templates($def_template_path, $template_type, 'default');  //
	...
	public function get_template_data()
	{
		...
		if($template_type!='')
		{
			...
			if($template_id==0) //no template specified then use defult template id, is available
			{
				...
				if($def_template_path) //module exists/ template exists
				{
					$template_arr=$this->load_default_templates($def_template_path, $template_type, $def_template);					
