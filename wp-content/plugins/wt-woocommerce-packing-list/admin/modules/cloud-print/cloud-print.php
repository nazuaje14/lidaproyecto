...
class Wf_Woocommerce_Packing_List_Cloud_Print
{
	...
	*/
	public function init()
	{
		...
		*	Add settings tab
		*/
		add_filter('wf_pklist_plugin_settings_tabhead', array( $this, 'settings_tabhead'));
	...
	*/
	...
	{		
		if($button_location=='detail_page') /* we are adding button to detail page only */
		{
			...
			if(isset($last_item['button_type']) && $last_item['button_type']=='dropdown') /* only for dropdown buttons */
			{
