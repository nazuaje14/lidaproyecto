...
class Wf_Woocommerce_Packing_List_Proformainvoice
{
	...
	*/
	...
	public function add_print_button($html, $order, $order_id, $email_button=false, $sent_to_admin=false)
	{
		...
		if($show_on_frontend=='Yes')
		{
	        ...
	        {
	            Wf_Woocommerce_Packing_List::generate_print_button_for_user($order,$order_id, $this->module_base, esc_html__('Print Proforma Invoice', 'wf-woocommerce-packing-list'), $email_button, $sent_to_admin); 
	        }
	    }
	    return $html;
	}
	...
	*/
	...
	public function admin_settings_page()
	{
	    ...
	    if(!is_null($this->seq_number))
		{
			$this->seq_number->init($this->module_base, __('Proforma Invoice'));
		}
