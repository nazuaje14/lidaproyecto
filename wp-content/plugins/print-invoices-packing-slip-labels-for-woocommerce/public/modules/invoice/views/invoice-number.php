	...
	<table class="form-table wf-form-table">
		...
		Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
			array(
				...
				'help_text'=>"Use any of the <a class=\"wf_inv_num_frmt_hlp_btn\" data-wf-trget=\"woocommerce_wf_invoice_number_prefix\">date formats</a> or alphanumeric characters.",
			),
			array(
				'label'=>__("Suffix",'print-invoices-packing-slip-labels-for-woocommerce'),
				'option_name'=>"woocommerce_wf_invoice_number_postfix",
				'help_text'=>"Use any of the <a class=\"wf_inv_num_frmt_hlp_btn\" data-wf-trget=\"woocommerce_wf_invoice_number_postfix\">date formats</a> or alphanumeric characters.",
			),
			array(
				'type'=>'number',
