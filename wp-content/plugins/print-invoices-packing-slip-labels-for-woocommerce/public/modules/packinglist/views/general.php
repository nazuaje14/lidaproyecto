...
<table class="form-table wf-form-table">
	...
	Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
		...
		array(
            ...
            'help_text'=>__("Add customer note in packing list",'print-invoices-packing-slip-labels-for-woocommerce'),
        ),
        array(
            'type'=>"radio",
            ...
            'help_text'=>__("Add footer in packing list",'print-invoices-packing-slip-labels-for-woocommerce'),
        ),
	),$this->module_id);
	?>
</table>