...
<table class="wf-form-table">
	...
	Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
		...
		array(
			...
			'help_text'=>__('Select/add additional order information in the delivery note.','wf-woocommerce-packing-list'),
		),
		array(
			'type'=>"product_meta",
			...
			'module_base'=>$this->module_base,
			'help_text'=>__('Select/add additional product information in the delivery note.','wf-woocommerce-packing-list'),
		),
		array(
